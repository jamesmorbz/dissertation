...
@router.get("/", response_model=List[DeviceDetails], tags=["All Devices"], summary="Get all device names")
async def devices():
...
@router.put("/{device_id}", response_model=DeviceDetails, tags=["Device"], summary="Update device metadata (friendly name, tags)")
